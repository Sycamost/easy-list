...
You can check if two lists share any elements with <code>shares</code>, which is equivalent to unifying the vectors, and checking to see if the result is non-empty.
